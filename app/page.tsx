    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans antialiased">
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled ? "backdrop-blur-md bg-black/50 border-b border-white/5" : ""
        }`}
      >
      ...
      {/* ─── SECTION 2: Hero ─── */}
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 pt-16 pb-20 sm:px-6 lg:px-8">
        {/* Background effects */}
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <p className="mt-6 max-w-xl text-base text-gray-400 sm:text-lg">
            ...
            accessibles depuis la Tunisie. Paie en dinars, sans carte internationale.
          </p>
          <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:gap-4">
            <Link
              href="/register"
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#6366f1] px-6 py-3.5 text-base font-semibold text-white transition-all duration-300 hover:bg-[#5558e3] hover:scale-[1.02]"
            >
      ...
      <section className="relative border-t border-white/5 py-24 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid gap-12 md:grid-cols-3 md:gap-6">
            <div className="relative flex flex-col items-center text-center md:items-start md:text-left">
              ...
              <p className="mt-2 text-sm text-gray-500">
                Paie en TND via D17, virement ou carte bancaire locale
              </p>
              <div className="absolute -right-3 top-12 hidden h-0.5 w-6 bg-gradient-to-r from-[#6366f1]/50 to-transparent md:block" />
            </div>
            <div className="relative flex flex-col items-center text-center md:items-start md:text-left">
              <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-[#6366f1]/20 text-sm font-bold text-[#6366f1]">
                2
              ...
              <p className="mt-2 text-sm text-gray-500">
                Parcours notre catalogue et sélectionne l&apos;abonnement dont
                tu as besoin
              </p>
              <div className="absolute -right-3 top-12 hidden h-0.5 w-6 bg-gradient-to-r from-[#6366f1]/50 to-transparent md:block" />
            </div>
            <div className="flex flex-col items-center text-center md:items-start md:text-left">
              ...
              <h3 className="text-lg font-semibold text-white">
                Reçois ton accès instantanément
              </h3>
              <p className="mt-2 text-sm text-gray-500">
                Tes identifiants sont livrés automatiquement en quelques minutes
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="border-t border-white/5 py-24 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-center text-3xl font-bold text-white sm:text-4xl">
            Services disponibles
          </h2>
      ...
      <section
        id="faq"
        className="border-t border-white/5 py-24 px-4 sm:px-6 lg:px-8"
      >
      ...
      <section className="relative overflow-hidden border-t border-white/5 py-24 px-4 sm:px-6 lg:px-8">
        <div
      ...
      <footer className="border-t border-white/5 bg-[#0a0a0a] px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <div className="mt-4 flex gap-3">
                <span className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 text-gray-500 transition-colors hover:border-[#6366f1]/50 hover:text-[#6366f1]">
                  <ExternalLink className="h-4 w-4" />
                </span>
              </div>
            </div>
          ...
          <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-white/5 pt-8 sm:flex-row">
            ...
            <p className="text-sm text-gray-500">Fait avec ❤️ en Tunisie 🇹🇳</p>
          </div>
        </div>
      </footer>
