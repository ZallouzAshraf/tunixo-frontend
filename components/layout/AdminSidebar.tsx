...
const items: Array<{
  ...
  { href: '/admin/deposits', label: 'Dépôts', icon: ArrowDownCircle, badge: 'deposits' },
  { href: '/admin/withdrawals', label: 'Retraits', icon: ArrowUpCircle, badge: 'withdrawals' },
  ...
  return (
    <aside className="flex w-[260px] shrink-0 flex-col border-r border-[#1e1e1e] bg-[#111111]">
      <div className="flex h-16 items-center gap-2 border-b border-[#1e1e1e] px-4">
        <span className="text-lg font-bold text-white">Tunixo</span>
